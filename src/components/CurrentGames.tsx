...
interface Props {
    ...
    onDelete: (id: string, title: string) => void; // добавили title
}

export function CurrentGames({ activeTab, isOwner, games, onAdd, onDelete }: Props) {
                        ...
                        >
                            ...
                            {isOwner && (
                                <button
                                    ...
                                    className="text-neutral-500 hover:text-red-400 transition shrink-0 p-0.5"
                                    title="Удалить"
                                >
